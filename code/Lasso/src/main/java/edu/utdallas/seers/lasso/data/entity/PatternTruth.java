...
public class PatternTruth {
    ...
    public static PatternTruth fromString(String input) {
    ...
    List<PatternSingleLineFormat> toSingleLineFormat(PatternType pType) {
        List<PatternSingleLineFormat> ret = new ArrayList<>();
        for (int l : lines) {
            ret.add(new PatternSingleLineFormat(file, l, true, pType));
        }
        return ret;
    }
