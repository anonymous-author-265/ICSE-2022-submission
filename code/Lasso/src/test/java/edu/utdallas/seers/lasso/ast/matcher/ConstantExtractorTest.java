...
import edu.utdallas.seers.lasso.data.entity.constants.IntegerConstant;
import edu.utdallas.seers.lasso.data.entity.constants.LongConstant;
...
public class ConstantExtractorTest {
    ...
    public static final Path TEST_FILE = Paths.get("sample/src/main/java/sample/type/resolution/ConstantExtractor.java");
