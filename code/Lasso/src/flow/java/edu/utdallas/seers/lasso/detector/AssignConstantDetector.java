...
import edu.utdallas.seers.lasso.data.entity.constants.ObjectConstant;
...
public class AssignConstantDetector extends ASTUnionDetector {
    ...
    List<Pattern> detectConstAssign(String operand, String constantString, PatternStore patternStore)
        ...
        return combinePatterns(detectedPatterns, patternStore, theConstant, Attribute.parse(operand));
    }
