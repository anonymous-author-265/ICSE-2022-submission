...
public class JSON {
    ...
    /**
     * Writes using a default adapter, which by default supports the following classes:
     * <ul>
     *     <li>{@link Path}.</li>
     * </ul>
     *
     ...
     * @param <T>      Type of the object.
     */
    public static <T extends JSONSerializable<AdapterSupplier>>
    void writeJSON(T object, Path filePath, boolean pretty) {
        writeJSON(object, filePath, pretty, new BasicSupplier());
    }
    ...
    public static <T extends JSONSerializable<AdapterSupplier>>
    T readJSON(Path filePath, Class<T> type) {
        return readJSON(filePath, type, new BasicSupplier());
    }
    ...
    private static class BasicSupplier extends AdapterSupplier {
        @Override
